...
<xsl:transform xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="m:history | m:event[not(name(../..)='provenance')] | m:titlePage | m:addDesc | m:projectDesc" mode="mei2html">
  ...
  <xsl:template match="m:p [name(..)!='changeDesc' and name(..)!='addDesc' and name(..)!='incipText' and name(../../..)!='provenance'] | m:list" mode="mei2html">
